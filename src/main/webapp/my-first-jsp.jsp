...
<%--
================================= MINI EXERCISE 1 (10/14/21)
1. Checkout to the jsp-and-jstl tag and branch off in branch called ‘jsp-mini-exercises’ - done
2. Create a jsp called ‘my-first-jsp.jsp’ - done
